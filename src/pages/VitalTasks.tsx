...
function VitalTasks() {
  return (
    <div className="grid grid-cols-12 gap-4 md:gap-2 h-full">
      <div
        className="col-span-12 md:col-span-6 lg:col-span-5 overflow-auto w-full gap-2 px-5 py-4 flex-1 min-h-48"
        style={container}
      >
      ...
      <div
        className="col-span-12 md:col-span-6  lg:col-span-7 w-full px-5 py-4 flex-1 overflow-auto"
        style={container}
      >
        <div className="flex justify-start items-end gap-2 mb-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="text-[10px] font-normal text-[#A1A3AB]">
        ...
        <div className="text-[16px] text-[#747474]">
          ...
          <div>
            <span className="font-bold">Objective:</span> To submit required
            documents for something important
          </div>
          <div>
            <span className="font-bold">Task Description:</span> Review the list
            of documents required for submission and ensure all necessary
            documents are ready. Organize the documents accordingly and scan
            them if physical copies need to be submitted digitally. Rename the
            scanned files appropriately for easy identification and verify the
            accepted file formats. Upload the documents securely to the
          ...
          <div>
            <span className="font-bold">Deadline for Submission:</span> End of
            Day
          </div>
        </div>
